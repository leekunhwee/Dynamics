...
b_190_h11_real = g*(xlsread('C:\Work\RCSA\Final\BEP0620.xls', 'b_190_h11', 'B249:B64121'))';
b_190_h11_imag = g*(xlsread('C:\Work\RCSA\Final\BEP0620.xls', 'b_190_h11', 'C249:C64121'))';
...
b_190_h12_real = g*(xlsread('C:\Work\RCSA\Final\BEP0620.xls', 'b_190_h21', 'B249:B64121'))';
b_190_h12_imag = g*(xlsread('C:\Work\RCSA\Final\BEP0620.xls', 'b_190_h21', 'C249:C64121'))';
b_190_h12 = b_190_h12_real + 1i*b_190_h12_imag;
b_190_h12n = b_190_h12./(1 - m_acc*b_190_h11);
b_190_h12NEW = b_190_h12n./(-(f * 2 * pi).^2);

%% FRF of Beam C 
c_140_h11_real = g*(xlsread('C:\Work\RCSA\Final\BEP0620.xls', 'c_140_h11', 'B249:B64121'))';
c_140_h11_imag = g*(xlsread('C:\Work\RCSA\Final\BEP0620.xls', 'c_140_h11', 'C249:C64121'))';
c_140_h11 = c_140_h11_real + 1i*c_140_h11_imag;
c_140_h11n = c_140_h11./(1 - m_acc*c_140_h11);
c_140_h11NEW = c_140_h11n./(-(f * 2 * pi).^2);

%% FRF of Beam D
d_190_h11_real = g*(xlsread('C:\Work\RCSA\Final\BEP0620.xls', 'd_190_h11', 'B249:B64121'))';
d_190_h11_imag = g*(xlsread('C:\Work\RCSA\Final\BEP0620.xls', 'd_190_h11', 'C249:C64121'))';
d_190_h11 = d_190_h11_real + 1i*d_190_h11_imag;
d_190_h11n = d_190_h11./(1 - m_acc*d_190_h11);
d_190_h11NEW = d_190_h11n./(-(f * 2 * pi).^2);

d_190_h12_real = g*(xlsread('C:\Work\RCSA\Final\BEP0620.xls', 'd_190_h21', 'B249:B64121'))';
d_190_h12_imag = g*(xlsread('C:\Work\RCSA\Final\BEP0620.xls', 'd_190_h21', 'C249:C64121'))';
