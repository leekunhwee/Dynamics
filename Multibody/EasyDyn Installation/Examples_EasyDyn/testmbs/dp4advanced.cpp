...
// Kinematics for body 1
body[1].omegarelpartial[1].put(0,0,1);
vec AG2=body[1].TrefG.R*vcoord(0,-0.5*l2,0);
body[1].vGrelpartial[1]=(body[1].omegarelpartial[1]^AG2);
ComposePartialVelocities(1,0);
}
...

{
  ...
  nbrdof=2;
  nbrbody=2;
  application=new char[20]; strcpy(application, "dp4advanced");
  InitEasyDynmbs();
